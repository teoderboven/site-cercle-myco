...
@section('main-content')
	<article>
		...
		<div class="main-content">
			<p>
				La sixième édition de la liste des champignons parasites des plantes déterminés par Arthur Vanderweyen
				est disponible ci-dessous. Il s'agit d'un fichier PDF. Sa dernière mise à jour date de février 2020.
			...
			<p>
				Elle concerne non seulement des récoltes de Belgique (pour cela, il y a le Catalogue des Urédinales de
				Belgique), mais aussi des spécimens qui ont été envoyés à l'auteur de l'étranger et qu'il n'y avait pas
				lieu d'ignorer. De nombreux spécimens ont été récoltés par diverses personnes, dont le nom est cité dans
				chaque cas, et dont la collaboration est vivement appréciée. L'édition de la version électronique de ce
				travail a été réalisée avec l'aide de Fernand Frix.
			</p>
			<section id="anchor-container">
				<h3>Navigation</h3>
				<p>
					Des signets vous permettent d'accéder facilement à cinq subdivisions de ce tableau, réalisé au
					format PDF&nbsp;:
				</p>
				<ol>
				...
				<p>Cliquez simplement sur un signet dans les menus de votre lecteur pdf pour accéder à la subdivision en
					question.</p>
				<div class="imageGroup">
					<figure>
						<img src="/assets/champi-parasite/demo-signet-parasites.gif" alt=""
						     title="Démonstration de comment naviguer facilement dans le document pdf" loading="lazy">
